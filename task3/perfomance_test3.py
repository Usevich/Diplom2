...
as_time, as_memory = readlog('acinhio_task3.log')
mult_time, mult_memory = readlog('multiprocessing_task3.log')
tread_time, tread_memory = readlog('threading_task3.log')
# Данные (примените свои данные)
